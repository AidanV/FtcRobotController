 ...
 */
public class NavxMicroNavigationSensor implements BNO055IMU {
    ...
    public NavxMicroNavigationSensor(VirtualBot bot){
        this.bot = bot;
    }

    public NavxMicroNavigationSensor(VirtualBot bot, int latencyMillis){
        this.bot = bot;
